...
public class HuoDaoGridViewAdapter extends BaseAdapter {
    private List data;
    private LayoutInflater layoutInflater;

    public HuoDaoGridViewAdapter(Context context, List data) {
        this.data = data;
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        String mingxi = (String) data.get(position);
        holder.btn.setText(mingxi);
        // 点击改变选中listItem的背景色
